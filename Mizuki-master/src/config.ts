...
export const siteConfig: SiteConfig = {
	...
	bilibili: {
		vmid: "54055135", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/kyrie1.webp",
				"/assets/desktop-banner/kyrie2.webp",
				"/assets/desktop-banner/kyrie3.webp",
				"/assets/desktop-banner/kyrie4.webp",
			], // 桌面横幅图片
			mobile: [
				"/assets/mobile-banner/kyrie1.webp",
				"/assets/mobile-banner/kyrie2.webp",
				"/assets/mobile-banner/kyrie3.webp",
				"/assets/mobile-banner/kyrie4.webp",
			], // 移动横幅图片
		}, // 使用本地横幅图片
		...
		homeText: {
			...
			title: "薯条人的个人博客", // 主页横幅主标题

			subtitle: [
				"欢迎来到我的博客！", // 主页横幅副标题，支持字符串数组以启用打字机效果
				"人生青葱，生活鱼块",
				"如果幸福如履薄冰，那我瑞幸加冰",
				"山高万仞，只登一步",
				"我无心与你一决高下",
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				...
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/54055135",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Douyin",
					url: "https://www.douyin.com/user/MS4wLjABAAAAKD7gXoehr1Yq_yVSHfiRBmtKUISmPRnlXwGkDqRYWhM?from_tab_name=main",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/my-avatar.png", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "美味薯条人",
	bio: "一个热爱技术的前端开发者，喜欢分享和交流。", // 个人简介
	typewriter: {
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://dataspace-kappa.vercel.app/",
		lang: SITE_LANG,
	},
	giscus: {
...
export const pioConfig: import("./types/config").PioConfig = {
	enable: true, // ⚠️ 把这里改成 true，启用原生看板娘！
	models: [
		// 替换为开源黑猫 Hijiki 的线上地址
		"https://fastly.jsdelivr.net/npm/live2d-widget-model-hijiki@1.0.5/assets/hijiki.model.json",
	],
	position: "left", // 模型位置
	width: 200, // 黑猫比较小，可以稍微改宽一点
	height: 250, // 默认高度
	mode: "draggable", // 默认为可拖拽模式（你可以用鼠标把它拖到网页任何地方！）
	hiddenOnMobile: true, // 手机端隐藏，防止挡住文章
	dialog: {
		// 结合你的个人风格，我帮你定制了专属的互动语录：
		welcome: "欢迎来到美味薯条人的代码小屋！",
		touch: [
			"别摸啦，快去看书，6月的六级考试还想不想高分过了？",
			"再摸我，我就把你爬塔的存档删掉！",
			"HENTAI！你的手速跟欧文运球一样快吗？",
			"不要这样欺负我！",
		],
		home: "点击这里返回首页！",
		skin: ["想要看看我的新衣服吗？", "新衣服看起来不错~"],
		close: "去打两把 Delta Force 放松下吧，下次再见~",
